...
-(void)initSiftView{
    ...
    _rightActionButton.backgroundColor = [[UIColor redColor] colorWithAlphaComponent:0.95];
    ...
    _leftActionButton.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.95];
